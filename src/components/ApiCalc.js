...
const CurrencyCalculator = () => {
  ...
  return (
    <Center bgColor="black" paddingTop="80px">
      <Box bg="black" p={4} borderRadius="md" align="center" minWidth="400px">
        ...
        <FormControl>
          ...
          <Select value={fromCurrency} onChange={(e) => setFromCurrency(e.target.value)} borderRadius="7px" marginBottom="10px" height="40px" color="orange">
        ...
        <FormControl>
          ...
          <Select value={toCurrency} onChange={(e) => setToCurrency(e.target.value)} borderRadius="7px" marginBottom="10px" height="40px" color="orange">
            {currencies.map(currency => (
              <option key={currency} value={currency}>{currency}</option>
            ))}
          </Select>
